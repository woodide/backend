...
public class Assignment {
    ...
    @Builder
    public Assignment(String assignmentName, String description, String language, String languageVersion, String testcase, String expectedResult, String uploadUrl, Member creator) {
